...
defs["ImDrawCmd_ImDrawCmd"][1]["comment"] = "// Also ensure our padding fields are zeroed"
...
defs["ImDrawData_AddDrawList"][1]["comment"] = "// Helper to add an external draw list into an existing ImDrawData."
...
defs["ImDrawData_DeIndexAllBuffers"][1]["comment"] = "// Helper to convert all buffers from indexed to non-indexed, in case you cannot render indexed. Note: this is slow and most likely a waste of resources. Always prefer indexed rendering!"
...
defs["ImDrawData_ScaleClipRects"][1]["comment"] = "// Helper to scale the ClipRect field of each ImDrawCmd. Use if your final output buffer is at a different scale than Dear ImGui expects, or if there is a difference between your window resolution and framebuffer resolution."
...
defs["ImDrawListSplitter_Clear"][1]["comment"] = "// Do not clear Channels[] so our allocations are reused next frame"
...
defs["ImDrawList_AddBezierCubic"][1]["comment"] = "// Cubic Bezier (4 control points)"
...
defs["ImDrawList_AddBezierQuadratic"][1]["comment"] = "// Quadratic Bezier (3 control points)"
...
defs["ImDrawList_AddCallback"][1]["comment"] = "// Your rendering function must check for 'UserCallback' in ImDrawCmd and call the function instead of rendering triangles."
...
defs["ImDrawList_AddDrawCmd"][1]["comment"] = "// This is useful if you need to forcefully create a new draw call (to allow for dependent rendering / blending). Otherwise primitives are merged into the same draw-call as much as possible"
...
defs["ImDrawList_AddRect"][1]["comment"] = "// a: upper-left, b: lower-right (== upper-left + size)"
...
defs["ImDrawList_AddRectFilled"][1]["comment"] = "// a: upper-left, b: lower-right (== upper-left + size)"
...
defs["ImDrawList_PathArcToFast"][1]["comment"] = "// Use precomputed angles for a 12 steps circle"
...
defs["ImDrawList_PathBezierCubicCurveTo"][1]["comment"] = "// Cubic Bezier (4 control points)"
...
defs["ImDrawList_PathBezierQuadraticCurveTo"][1]["comment"] = "// Quadratic Bezier (3 control points)"
...
defs["ImDrawList_PathEllipticalArcTo"][1]["comment"] = "// Ellipse"
...
defs["ImDrawList_PrimRect"][1]["comment"] = "// Axis aligned rectangle (composed of two triangles)"
...
defs["ImDrawList_PrimVtx"][1]["comment"] = "// Write vertex with unique index"
...
defs["ImDrawList_PushClipRect"][1]["comment"] = "// Render-level scissoring. This is passed down to your render function but not used for CPU-side coarse clipping. Prefer using higher-level ImGui::PushClipRect() to affect logic (hit-testing and widget culling)"
...
defs["ImFontAtlas_AddFontFromMemoryCompressedBase85TTF"][1]["comment"] = "// 'compressed_font_data_base85' still owned by caller. Compress with binary_to_compressed_c.cpp with -base85 parameter."
...
defs["ImFontAtlas_AddFontFromMemoryCompressedTTF"][1]["comment"] = "// 'compressed_font_data' still owned by caller. Compress with binary_to_compressed_c.cpp."
...
defs["ImFontAtlas_AddFontFromMemoryTTF"][1]["comment"] = "// Note: Transfer ownership of 'ttf_data' to ImFontAtlas! Will be deleted after destruction of the atlas. Set font_cfg->FontDataOwnedByAtlas=false to keep ownership of your data and it won't be freed."
...
defs["ImFontAtlas_Build"][1]["comment"] = "// Build pixels data. This is called automatically for you by the GetTexData*** functions."
...
defs["ImFontAtlas_ClearFonts"][1]["comment"] = "// Clear output font data (glyphs storage, UV coordinates)."
...
defs["ImFontAtlas_ClearInputData"][1]["comment"] = "// Clear input data (all ImFontConfig structures including sizes, TTF data, glyph ranges, etc.) = all the data used to build the texture and fonts."
...
defs["ImFontAtlas_ClearTexData"][1]["comment"] = "// Clear output texture data (CPU side). Saves RAM once the texture has been copied to graphics memory."
...
defs["ImFontAtlas_GetGlyphRangesChineseFull"][1]["comment"] = "// Default + Half-Width + Japanese Hiragana/Katakana + full set of about 21000 CJK Unified Ideographs"
...
defs["ImFontAtlas_GetGlyphRangesChineseSimplifiedCommon"][1]["comment"] = "// Default + Half-Width + Japanese Hiragana/Katakana + set of 2500 CJK Unified Ideographs for common simplified Chinese"
...
defs["ImFontAtlas_GetGlyphRangesCyrillic"][1]["comment"] = "// Default + about 400 Cyrillic characters"
...
defs["ImFontAtlas_GetGlyphRangesDefault"][1]["comment"] = "// Basic Latin, Extended Latin"
...
defs["ImFontAtlas_GetGlyphRangesGreek"][1]["comment"] = "// Default + Greek and Coptic"
...
defs["ImFontAtlas_GetGlyphRangesJapanese"][1]["comment"] = "// Default + Hiragana, Katakana, Half-Width, Selection of 2999 Ideographs"
...
defs["ImFontAtlas_GetGlyphRangesKorean"][1]["comment"] = "// Default + Korean characters"
...
defs["ImFontAtlas_GetGlyphRangesThai"][1]["comment"] = "// Default + Thai characters"
...
defs["ImFontAtlas_GetGlyphRangesVietnamese"][1]["comment"] = "// Default + Vietnamese characters"
...
defs["ImFontAtlas_GetTexDataAsAlpha8"][1]["comment"] = "// 1 byte per-pixel"
...
defs["ImFontAtlas_GetTexDataAsRGBA32"][1]["comment"] = "// 4 bytes-per-pixel"
...
defs["ImFontAtlas_IsBuilt"][1]["comment"] = "// Bit ambiguous: used to detect when user didn't build texture but effectively we should check TexID != 0 except that would be backend dependent..."
...
defs["ImFontGlyphRangesBuilder_AddChar"][1]["comment"] = "// Add character"
...
defs["ImFontGlyphRangesBuilder_AddRanges"][1]["comment"] = "// Add ranges, e.g. builder.AddRanges(ImFontAtlas::GetGlyphRangesDefault()) to force add all of ASCII/Latin+Ext"
...
defs["ImFontGlyphRangesBuilder_AddText"][1]["comment"] = "// Add string (each character of the UTF-8 string are added)"
...
defs["ImFontGlyphRangesBuilder_BuildRanges"][1]["comment"] = "// Output new ranges"
...
defs["ImFontGlyphRangesBuilder_GetBit"][1]["comment"] = "// Get bit n in the array"
...
defs["ImFontGlyphRangesBuilder_SetBit"][1]["comment"] = "// Set bit n in the array"
...
defs["ImFont_AddRemapChar"][1]["comment"] = "// Makes 'dst' character/glyph points to 'src' character/glyph. Currently needs to be called AFTER fonts have been built."
...
defs["ImFont_CalcTextSizeA"][1]["comment"] = "// utf8"
...
defs["ImGuiIO_AddFocusEvent"][1]["comment"] = "// Queue a gain/loss of focus for the application (generally based on OS/platform focus of your window)"
...
defs["ImGuiIO_AddInputCharacter"][1]["comment"] = "// Queue a new character input"
...
defs["ImGuiIO_AddInputCharacterUTF16"][1]["comment"] = "// Queue a new character input from a UTF-16 character, it can be a surrogate"
...
defs["ImGuiIO_AddInputCharactersUTF8"][1]["comment"] = "// Queue a new characters input from a UTF-8 string"
...
defs["ImGuiIO_AddKeyAnalogEvent"][1]["comment"] = "// Queue a new key down/up event for analog values (e.g. ImGuiKey_Gamepad_ values). Dead-zones should be handled by the backend."
...
defs["ImGuiIO_AddKeyEvent"][1]["comment"] = "// Queue a new key down/up event. Key should be \"translated\" (as in, generally ImGuiKey_A matches the key end-user would use to emit an 'A' character)"
...
defs["ImGuiIO_AddMouseButtonEvent"][1]["comment"] = "// Queue a mouse button change"
...
defs["ImGuiIO_AddMousePosEvent"][1]["comment"] = "// Queue a mouse position update. Use -FLT_MAX,-FLT_MAX to signify no mouse (e.g. app not focused and not hovered)"
...
defs["ImGuiIO_AddMouseSourceEvent"][1]["comment"] = "// Queue a mouse source change (Mouse/TouchScreen/Pen)"
...
defs["ImGuiIO_AddMouseViewportEvent"][1]["comment"] = "// Queue a mouse hovered viewport. Requires backend to set ImGuiBackendFlags_HasMouseHoveredViewport to call this (for multi-viewport support)."
...
defs["ImGuiIO_AddMouseWheelEvent"][1]["comment"] = "// Queue a mouse wheel update. wheel_y<0: scroll down, wheel_y>0: scroll up, wheel_x<0: scroll right, wheel_x>0: scroll left."
...
defs["ImGuiIO_ClearEventsQueue"][1]["comment"] = "// Clear all incoming events."
...
defs["ImGuiIO_ClearInputKeys"][1]["comment"] = "// Clear current keyboard/mouse/gamepad state + current frame text input buffer. Equivalent to releasing all keys/buttons."
...
defs["ImGuiIO_SetAppAcceptingEvents"][1]["comment"] = "// Set master flag for accepting key/mouse/text events (default to true). Useful if you have native dialog boxes that are interrupting your application loop/refresh, and you want to disable events being queued while your app is frozen."
...
defs["ImGuiIO_SetKeyEventNativeData"][1]["comment"] = "// [Optional] Specify index for legacy <1.87 IsKeyXXX() functions with native indices + specify native keycode, scancode."
...
defs["ImGuiListClipper_End"][1]["comment"] = "// Automatically called on the last call of Step() that returns false."
...
defs["ImGuiListClipper_IncludeItemsByIndex"][1]["comment"] = "// item_end is exclusive e.g. use (42, 42+1) to make item 42 never clipped."
...
defs["ImGuiListClipper_Step"][1]["comment"] = "// Call until it returns false. The DisplayStart/DisplayEnd fields will be set and you can process/draw those items."
...
defs["ImGuiPlatformIO_ImGuiPlatformIO"][1]["comment"] = "// Zero clear"
...
defs["ImGuiStorage_GetVoidPtr"][1]["comment"] = "// default_val is NULL"
...
defs["ImGuiTextBuffer_end"][1]["comment"] = "// Buf is zero-terminated, so end() will point on the zero-terminator"
...
defs["ImGuiTextFilter_Draw"][1]["comment"] = "// Helper calling InputText+Build"
...
defs["ImVector_clear"][1]["comment"] = "// Important: does not destruct anything"
...
defs["ImVector_clear_delete"][1]["comment"] = "// Important: never called automatically! always explicit."
...
defs["ImVector_clear_destruct"][1]["comment"] = "// Important: never called automatically! always explicit."
...
defs["ImVector_shrink"][1]["comment"] = "// Resize a vector to a smaller size, guaranteed not to cause a reallocation"
...
defs["igAcceptDragDropPayload"][1]["comment"] = "// accept contents of a given type. If ImGuiDragDropFlags_AcceptBeforeDelivery is set you can peek into the payload before the mouse button is released."
...
defs["igAlignTextToFramePadding"][1]["comment"] = "// vertically align upcoming text baseline to FramePadding.y so that it will align properly to regularly framed items (call if you have text on a line before a framed item)"
...
defs["igArrowButton"][1]["comment"] = "// square button with an arrow shape"
...
defs["igBeginDragDropSource"][1]["comment"] = "// call after submitting an item which may be dragged. when this return true, you can call SetDragDropPayload() + EndDragDropSource()"
...
defs["igBeginDragDropTarget"][1]["comment"] = "// call after submitting an item that may receive a payload. If this returns true, you can call AcceptDragDropPayload() + EndDragDropTarget()"
...
defs["igBeginGroup"][1]["comment"] = "// lock horizontal starting position"
...
defs["igBeginItemTooltip"][1]["comment"] = "// begin/append a tooltip window if preceding item was hovered."
...
defs["igBeginListBox"][1]["comment"] = "// open a framed scrolling region"
...
defs["igBeginMainMenuBar"][1]["comment"] = "// create and append to a full screen menu-bar."
...
defs["igBeginMenu"][1]["comment"] = "// create a sub-menu entry. only call EndMenu() if this returns true!"
...
defs["igBeginMenuBar"][1]["comment"] = "// append to menu-bar of current window (requires ImGuiWindowFlags_MenuBar flag set on parent window)."
...
defs["igBeginPopup"][1]["comment"] = "// return true if the popup is open, and you can start outputting to it."
...
defs["igBeginPopupContextItem"][1]["comment"] = "// open+begin popup when clicked on last item. Use str_id==NULL to associate the popup to previous item. If you want to use that on a non-interactive item such as Text() you need to pass in an explicit ID here. read comments in .cpp!"
...
defs["igBeginPopupContextVoid"][1]["comment"] = "// open+begin popup when clicked in void (where there are no windows)."
...
defs["igBeginPopupContextWindow"][1]["comment"] = "// open+begin popup when clicked on current window."
...
defs["igBeginPopupModal"][1]["comment"] = "// return true if the modal is open, and you can start outputting to it."
...
defs["igBeginTabBar"][1]["comment"] = "// create and append into a TabBar"
...
defs["igBeginTabItem"][1]["comment"] = "// create a Tab. Returns true if the Tab is selected."
...
defs["igBeginTooltip"][1]["comment"] = "// begin/append a tooltip window."
...
defs["igBullet"][1]["comment"] = "// draw a small circle + keep the cursor on the same line. advance cursor x position by GetTreeNodeToLabelSpacing(), same distance that TreeNode() uses"
...
defs["igBulletText"][1]["comment"] = "// shortcut for Bullet()+Text()"
...
defs["igButton"][1]["comment"] = "// button"
...
defs["igCalcItemWidth"][1]["comment"] = "// width of item given pushed settings and current cursor position. NOT necessarily the width of last item unlike most 'Item' functions."
...
defs["igCloseCurrentPopup"][1]["comment"] = "// manually close the popup we have begin-ed into."
...
defs["igCollapsingHeader"][1]["comment"] = "// if returning 'true' the header is open. doesn't indent nor push on ID stack. user doesn't have to call TreePop()."
...
defs["igCollapsingHeader"][2]["comment"] = "// when 'p_visible != NULL': if '*p_visible==true' display an additional small close button on upper right of the header which will set the bool to false when clicked, if '*p_visible==false' don't display the header."
...
defs["igColorButton"][1]["comment"] = "// display a color square/button, hover for details, return true when pressed."
...
defs["igCombo"][2]["comment"] = "// Separate items with \\0 within a string, end item-list with \\0\\0. e.g. \"One\\0Two\\0Three\\0\""
...
defs["igDebugCheckVersionAndDataLayout"][1]["comment"] = "// This is called by IMGUI_CHECKVERSION() macro."
...
defs["igDestroyContext"][1]["comment"] = "// NULL = destroy current context"
...
defs["igDestroyPlatformWindows"][1]["comment"] = "// call DestroyWindow platform functions for all viewports. call from backend Shutdown() if you need to close platform windows before imgui shutdown. otherwise will be called by DestroyContext()."
...
defs["igDragFloat"][1]["comment"] = "// If v_min >= v_max we have no bound"
...
defs["igDragInt"][1]["comment"] = "// If v_min >= v_max we have no bound"
...
defs["igDummy"][1]["comment"] = "// add a dummy item of given size. unlike InvisibleButton(), Dummy() won't take the mouse click or be navigable into."
...
defs["igEndCombo"][1]["comment"] = "// only call EndCombo() if BeginCombo() returns true!"
...
defs["igEndDragDropSource"][1]["comment"] = "// only call EndDragDropSource() if BeginDragDropSource() returns true!"
...
defs["igEndDragDropTarget"][1]["comment"] = "// only call EndDragDropTarget() if BeginDragDropTarget() returns true!"
...
defs["igEndFrame"][1]["comment"] = "// ends the Dear ImGui frame. automatically called by Render(). If you don't need to render data (skipping rendering) you may call EndFrame() without Render()... but you'll have wasted CPU already! If you don't need to render, better to not create any windows and not call NewFrame() at all!"
...
defs["igEndGroup"][1]["comment"] = "// unlock horizontal starting position + capture the whole group bounding box into one \"item\" (so you can use IsItemHovered() or layout primitives such as SameLine() on whole group, etc.)"
...
defs["igEndListBox"][1]["comment"] = "// only call EndListBox() if BeginListBox() returned true!"
...
defs["igEndMainMenuBar"][1]["comment"] = "// only call EndMainMenuBar() if BeginMainMenuBar() returns true!"
...
defs["igEndMenu"][1]["comment"] = "// only call EndMenu() if BeginMenu() returns true!"
...
defs["igEndMenuBar"][1]["comment"] = "// only call EndMenuBar() if BeginMenuBar() returns true!"
...
defs["igEndPopup"][1]["comment"] = "// only call EndPopup() if BeginPopupXXX() returns true!"
...
defs["igEndTabBar"][1]["comment"] = "// only call EndTabBar() if BeginTabBar() returns true!"
...
defs["igEndTabItem"][1]["comment"] = "// only call EndTabItem() if BeginTabItem() returns true!"
...
defs["igEndTable"][1]["comment"] = "// only call EndTable() if BeginTable() returns true!"
...
defs["igEndTooltip"][1]["comment"] = "// only call EndTooltip() if BeginTooltip()/BeginItemTooltip() returns true!"
...
defs["igFindViewportByID"][1]["comment"] = "// this is a helper for backends."
...
defs["igFindViewportByPlatformHandle"][1]["comment"] = "// this is a helper for backends. the type platform_handle is decided by the backend (e.g. HWND, MyWindow*, GLFWwindow* etc.)"
...
defs["igGetBackgroundDrawList"][1]["comment"] = "// get background draw list for the viewport associated to the current window. this draw list will be the first rendering one. Useful to quickly draw shapes/text behind dear imgui contents."
...
defs["igGetBackgroundDrawList"][2]["comment"] = "// get background draw list for the given viewport. this draw list will be the first rendering one. Useful to quickly draw shapes/text behind dear imgui contents."
...
defs["igGetColorU32"][1]["comment"] = "// retrieve given style color with style alpha applied and optional extra alpha multiplier, packed as a 32-bit value suitable for ImDrawList"
...
defs["igGetColorU32"][2]["comment"] = "// retrieve given color with style alpha applied, packed as a 32-bit value suitable for ImDrawList"
...
defs["igGetColorU32"][3]["comment"] = "// retrieve given color with style alpha applied, packed as a 32-bit value suitable for ImDrawList"
...
defs["igGetColumnIndex"][1]["comment"] = "// get current column index"
...
defs["igGetColumnOffset"][1]["comment"] = "// get position of column line (in pixels, from the left side of the contents region). pass -1 to use current column, otherwise 0..GetColumnsCount() inclusive. column 0 is typically 0.0f"
...
defs["igGetColumnWidth"][1]["comment"] = "// get column width (in pixels). pass -1 to use current column"
...
defs["igGetContentRegionAvail"][1]["comment"] = "// == GetContentRegionMax() - GetCursorPos()"
...
defs["igGetContentRegionMax"][1]["comment"] = "// current content boundaries (typically window boundaries including scrolling, or current column boundaries), in windows coordinates"
...
defs["igGetCursorPos"][1]["comment"] = "// [window-local] cursor position in window coordinates (relative to window position)"
...
defs["igGetCursorPosX"][1]["comment"] = "// [window-local] \""
...
defs["igGetCursorPosY"][1]["comment"] = "// [window-local] \""
...
defs["igGetCursorScreenPos"][1]["comment"] = "// cursor position in absolute coordinates (prefer using this, also more useful to work with ImDrawList API)."
...
defs["igGetCursorStartPos"][1]["comment"] = "// [window-local] initial cursor position, in window coordinates"
...
defs["igGetDragDropPayload"][1]["comment"] = "// peek directly into the current payload from anywhere. returns NULL when drag and drop is finished or inactive. use ImGuiPayload::IsDataType() to test for the payload type."
...
defs["igGetDrawListSharedData"][1]["comment"] = "// you may use this when creating your own ImDrawList instances."
...
defs["igGetFont"][1]["comment"] = "// get current font"
...
defs["igGetFontSize"][1]["comment"] = "// get current font size (= height in pixels) of current font with current scale applied"
...
defs["igGetFontTexUvWhitePixel"][1]["comment"] = "// get UV coordinate for a while pixel, useful to draw custom shapes via the ImDrawList API"
...
defs["igGetForegroundDrawList"][1]["comment"] = "// get foreground draw list for the viewport associated to the current window. this draw list will be the last rendered one. Useful to quickly draw shapes/text over dear imgui contents."
...
defs["igGetForegroundDrawList"][2]["comment"] = "// get foreground draw list for the given viewport. this draw list will be the last rendered one. Useful to quickly draw shapes/text over dear imgui contents."
...
defs["igGetFrameCount"][1]["comment"] = "// get global imgui frame count. incremented by 1 every frame."
...
defs["igGetFrameHeight"][1]["comment"] = "// ~ FontSize + style.FramePadding.y * 2"
...
defs["igGetID"][1]["comment"] = "// calculate unique ID (hash of whole ID stack + given parameter). e.g. if you want to query into ImGuiStorage yourself"
...
defs["igGetIO"][1]["comment"] = "// access the IO structure (mouse/keyboard/gamepad inputs, time, various configuration options/flags)"
...
defs["igGetItemID"][1]["comment"] = "// get ID of last item (~~ often same ImGui::GetID(label) beforehand)"
...
defs["igGetItemRectMax"][1]["comment"] = "// get lower-right bounding rectangle of the last item (screen space)"
...
defs["igGetItemRectMin"][1]["comment"] = "// get upper-left bounding rectangle of the last item (screen space)"
...
defs["igGetItemRectSize"][1]["comment"] = "// get size of last item"
...
defs["igGetKeyName"][1]["comment"] = "// [DEBUG] returns English name of the key. Those names a provided for debugging purpose and are not meant to be saved persistently not compared."
...
defs["igGetKeyPressedAmount"][1]["comment"] = "// uses provided repeat rate/delay. return a count, most often 0 or 1 but might be >1 if RepeatRate is small enough that DeltaTime > RepeatRate"
...
defs["igGetMainViewport"][1]["comment"] = "// return primary/default viewport. This can never be NULL."
...
defs["igGetMouseClickedCount"][1]["comment"] = "// return the number of successive mouse-clicks at the time where a click happen (otherwise 0)."
...
defs["igGetMouseCursor"][1]["comment"] = "// get desired mouse cursor shape. Important: reset in ImGui::NewFrame(), this is updated during the frame. valid before Render(). If you use software rendering by setting io.MouseDrawCursor ImGui will render those for you"
...
defs["igGetMouseDragDelta"][1]["comment"] = "// return the delta from the initial clicking position while the mouse button is pressed or was just released. This is locked and return 0.0f until the mouse moves past a distance threshold at least once (if lock_threshold < -1.0f, uses io.MouseDraggingThreshold)"
...
defs["igGetMousePos"][1]["comment"] = "// shortcut to ImGui::GetIO().MousePos provided by user, to be consistent with other calls"
...
defs["igGetMousePosOnOpeningCurrentPopup"][1]["comment"] = "// retrieve mouse position at the time of opening popup we have BeginPopup() into (helper to avoid user backing that value themselves)"
...
defs["igGetPlatformIO"][1]["comment"] = "// platform/renderer functions, for backend to setup + viewports list."
...
defs["igGetScrollMaxX"][1]["comment"] = "// get maximum scrolling amount ~~ ContentSize.x - WindowSize.x - DecorationsSize.x"
...
defs["igGetScrollMaxY"][1]["comment"] = "// get maximum scrolling amount ~~ ContentSize.y - WindowSize.y - DecorationsSize.y"
...
defs["igGetScrollX"][1]["comment"] = "// get scrolling amount [0 .. GetScrollMaxX()]"
...
defs["igGetScrollY"][1]["comment"] = "// get scrolling amount [0 .. GetScrollMaxY()]"
...
defs["igGetStyle"][1]["comment"] = "// access the Style structure (colors, sizes). Always use PushStyleColor(), PushStyleVar() to modify style mid-frame!"
...
defs["igGetStyleColorName"][1]["comment"] = "// get a string corresponding to the enum value (for display, saving, etc.)."
...
defs["igGetStyleColorVec4"][1]["comment"] = "// retrieve style color as stored in ImGuiStyle structure. use to feed back into PushStyleColor(), otherwise use GetColorU32() to get style color with style alpha baked in."
...
defs["igGetTextLineHeight"][1]["comment"] = "// ~ FontSize"
...
defs["igGetTextLineHeightWithSpacing"][1]["comment"] = "// ~ FontSize + style.ItemSpacing.y (distance in pixels between 2 consecutive lines of text)"
...
defs["igGetTime"][1]["comment"] = "// get global imgui time. incremented by io.DeltaTime every frame."
...
defs["igGetTreeNodeToLabelSpacing"][1]["comment"] = "// horizontal distance preceding label when using TreeNode*() or Bullet() == (g.FontSize + style.FramePadding.x*2) for a regular unframed TreeNode"
...
defs["igGetVersion"][1]["comment"] = "// get the compiled version string e.g. \"1.80 WIP\" (essentially the value for IMGUI_VERSION from the compiled version of imgui.cpp)"
...
defs["igGetWindowContentRegionMax"][1]["comment"] = "// content boundaries max for the full window (roughly (0,0)+Size-Scroll) where Size can be overridden with SetNextWindowContentSize(), in window coordinates"
...
defs["igGetWindowContentRegionMin"][1]["comment"] = "// content boundaries min for the full window (roughly (0,0)-Scroll), in window coordinates"
...
defs["igGetWindowDpiScale"][1]["comment"] = "// get DPI scale currently associated to the current window's viewport."
...
defs["igGetWindowDrawList"][1]["comment"] = "// get draw list associated to the current window, to append your own drawing primitives"
...
defs["igGetWindowPos"][1]["comment"] = "// get current window position in screen space (note: it is unlikely you need to use this. Consider using current layout pos instead, GetCursorScreenPos())"
...
defs["igGetWindowSize"][1]["comment"] = "// get current window size (note: it is unlikely you need to use this. Consider using GetCursorScreenPos() and e.g. GetContentRegionAvail() instead)"
...
defs["igGetWindowViewport"][1]["comment"] = "// get viewport currently associated to the current window."
...
defs["igGetWindowWidth"][1]["comment"] = "// get current window width (shortcut for GetWindowSize().x)"
...
defs["igIndent"][1]["comment"] = "// move content position toward the right, by indent_w, or style.IndentSpacing if indent_w <= 0"
...
defs["igInvisibleButton"][1]["comment"] = "// flexible button behavior without the visuals, frequently useful to build custom behaviors using the public api (along with IsItemActive, IsItemHovered, etc.)"
...
defs["igIsAnyItemActive"][1]["comment"] = "// is any item active?"
...
defs["igIsAnyItemFocused"][1]["comment"] = "// is any item focused?"
...
defs["igIsAnyItemHovered"][1]["comment"] = "// is any item hovered?"
...
defs["igIsAnyMouseDown"][1]["comment"] = "// [WILL OBSOLETE] is any mouse button held? This was designed for backends, but prefer having backend maintain a mask of held mouse buttons, because upcoming input queue system will make this invalid."
...
defs["igIsItemActivated"][1]["comment"] = "// was the last item just made active (item was previously inactive)."
...
defs["igIsItemActive"][1]["comment"] = "// is the last item active? (e.g. button being held, text field being edited. This will continuously return true while holding mouse button on an item. Items that don't interact will always return false)"
...
defs["igIsItemClicked"][1]["comment"] = "// is the last item hovered and mouse clicked on? (**)  == IsMouseClicked(mouse_button) && IsItemHovered()Important. (**) this is NOT equivalent to the behavior of e.g. Button(). Read comments in function definition."
...
defs["igIsItemDeactivated"][1]["comment"] = "// was the last item just made inactive (item was previously active). Useful for Undo/Redo patterns with widgets that require continuous editing."
...
defs["igIsItemDeactivatedAfterEdit"][1]["comment"] = "// was the last item just made inactive and made a value change when it was active? (e.g. Slider/Drag moved). Useful for Undo/Redo patterns with widgets that require continuous editing. Note that you may get false positives (some widgets such as Combo()/ListBox()/Selectable() will return true even when clicking an already selected item)."
...
defs["igIsItemEdited"][1]["comment"] = "// did the last item modify its underlying value this frame? or was pressed? This is generally the same as the \"bool\" return value of many widgets."
...
defs["igIsItemFocused"][1]["comment"] = "// is the last item focused for keyboard/gamepad navigation?"
...
defs["igIsItemHovered"][1]["comment"] = "// is the last item hovered? (and usable, aka not blocked by a popup, etc.). See ImGuiHoveredFlags for more options."
...
defs["igIsItemToggledOpen"][1]["comment"] = "// was the last item open state toggled? set by TreeNode()."
...
defs["igIsItemVisible"][1]["comment"] = "// is the last item visible? (items may be out of sight because of clipping/scrolling)"
...
defs["igIsKeyChordPressed"][1]["comment"] = "// was key chord (mods + key) pressed, e.g. you can pass 'ImGuiMod_Ctrl | ImGuiKey_S' as a key-chord. This doesn't do any routing or focus check, please consider using Shortcut() function instead."
...
defs["igIsKeyDown"][1]["comment"] = "// is key being held."
...
defs["igIsKeyPressed"][1]["comment"] = "// was key pressed (went from !Down to Down)? if repeat=true, uses io.KeyRepeatDelay / KeyRepeatRate"
...
defs["igIsKeyReleased"][1]["comment"] = "// was key released (went from Down to !Down)?"
...
defs["igIsMouseClicked"][1]["comment"] = "// did mouse button clicked? (went from !Down to Down). Same as GetMouseClickedCount() == 1."
...
defs["igIsMouseDoubleClicked"][1]["comment"] = "// did mouse button double-clicked? Same as GetMouseClickedCount() == 2. (note that a double-click will also report IsMouseClicked() == true)"
...
defs["igIsMouseDown"][1]["comment"] = "// is mouse button held?"
...
defs["igIsMouseDragging"][1]["comment"] = "// is mouse dragging? (if lock_threshold < -1.0f, uses io.MouseDraggingThreshold)"
...
defs["igIsMouseHoveringRect"][1]["comment"] = "// is mouse hovering given bounding rect (in screen space). clipped by current clipping settings, but disregarding of other consideration of focus/window ordering/popup-block."
...
defs["igIsMousePosValid"][1]["comment"] = "// by convention we use (-FLT_MAX,-FLT_MAX) to denote that there is no mouse available"
...
defs["igIsMouseReleased"][1]["comment"] = "// did mouse button released? (went from Down to !Down)"
...
defs["igIsPopupOpen"][1]["comment"] = "// return true if the popup is open."
...
defs["igIsRectVisible"][1]["comment"] = "// test if rectangle (of given size, starting from cursor position) is visible / not clipped."
...
defs["igIsRectVisible"][2]["comment"] = "// test if rectangle (in screen space) is visible / not clipped. to perform coarse clipping on user's side."
...
defs["igIsWindowDocked"][1]["comment"] = "// is current window docked into another window?"
...
defs["igIsWindowFocused"][1]["comment"] = "// is current window focused? or its root/child, depending on flags. see flags for options."
...
defs["igIsWindowHovered"][1]["comment"] = "// is current window hovered and hoverable (e.g. not blocked by a popup/modal)? See ImGuiHoveredFlags_ for options. IMPORTANT: If you are trying to check whether your mouse should be dispatched to Dear ImGui or to your underlying app, you should not use this function! Use the 'io.WantCaptureMouse' boolean for that! Refer to FAQ entry \"How can I tell whether to dispatch mouse/keyboard to Dear ImGui or my application?\" for details."
...
defs["igLabelText"][1]["comment"] = "// display text+label aligned the same way as value+label widgets"
...
defs["igLoadIniSettingsFromDisk"][1]["comment"] = "// call after CreateContext() and before the first call to NewFrame(). NewFrame() automatically calls LoadIniSettingsFromDisk(io.IniFilename)."
...
defs["igLoadIniSettingsFromMemory"][1]["comment"] = "// call after CreateContext() and before the first call to NewFrame() to provide .ini data from your own data source."
...
defs["igLogButtons"][1]["comment"] = "// helper to display buttons for logging to tty/file/clipboard"
...
defs["igLogFinish"][1]["comment"] = "// stop logging (close file, etc.)"
...
defs["igLogToClipboard"][1]["comment"] = "// start logging to OS clipboard"
...
defs["igLogToFile"][1]["comment"] = "// start logging to file"
...
defs["igLogToTTY"][1]["comment"] = "// start logging to tty (stdout)"
...
defs["igMenuItem"][1]["comment"] = "// return true when activated."
...
defs["igNewFrame"][1]["comment"] = "// start a new Dear ImGui frame, you can submit any command from this point until Render()/EndFrame()."
...
defs["igNewLine"][1]["comment"] = "// undo a SameLine() or force a new line when in a horizontal-layout context."
...
defs["igNextColumn"][1]["comment"] = "// next column, defaults to current row or next row if the current row is finished"
...
defs["igOpenPopup"][1]["comment"] = "// call to mark popup as open (don't call every frame!)."
...
defs["igOpenPopup"][2]["comment"] = "// id overload to facilitate calling from nested stacks"
...
defs["igOpenPopupOnItemClick"][1]["comment"] = "// helper to open popup when clicked on last item. Default to ImGuiPopupFlags_MouseButtonRight == 1. (note: actually triggers on the mouse _released_ event to be consistent with popup behaviors)"
...
defs["igPopID"][1]["comment"] = "// pop from the ID stack."
...
defs["igPushButtonRepeat"][1]["comment"] = "// in 'repeat' mode, Button*() functions return repeated true in a typematic manner (using io.KeyRepeatDelay/io.KeyRepeatRate setting). Note that you can call IsItemActive() after any Button() to tell if the button is held in the current frame."
...
defs["igPushFont"][1]["comment"] = "// use NULL as a shortcut to push default font"
...
defs["igPushID"][1]["comment"] = "// push string into the ID stack (will hash string)."
...
defs["igPushID"][2]["comment"] = "// push string into the ID stack (will hash string)."
...
defs["igPushID"][3]["comment"] = "// push pointer into the ID stack (will hash pointer)."
...
defs["igPushID"][4]["comment"] = "// push integer into the ID stack (will hash integer)."
...
defs["igPushItemWidth"][1]["comment"] = "// push width of items for common large \"item+label\" widgets. >0.0f: width in pixels, <0.0f align xx pixels to the right of window (so -FLT_MIN always align width to the right side)."
...
defs["igPushStyleVar"][1]["comment"] = "// modify a style float variable. always use this if you modify the style after NewFrame()."
...
defs["igPushStyleVar"][2]["comment"] = "// modify a style ImVec2 variable. always use this if you modify the style after NewFrame()."
...
defs["igPushTabStop"][1]["comment"] = "// == tab stop enable. Allow focusing using TAB/Shift-TAB, enabled by default but you can disable it for certain widgets"
...
defs["igPushTextWrapPos"][1]["comment"] = "// push word-wrapping position for Text*() commands. < 0.0f: no wrapping; 0.0f: wrap to end of window (or column); > 0.0f: wrap at 'wrap_pos_x' position in window local space"
...
defs["igRadioButton"][1]["comment"] = "// use with e.g. if (RadioButton(\"one\", my_value==1))  my_value = 1; "
...
defs["igRadioButton"][2]["comment"] = "// shortcut to handle the above pattern when value is an integer"
...
defs["igRender"][1]["comment"] = "// ends the Dear ImGui frame, finalize the draw data. You can then get call GetDrawData()."
...
defs["igRenderPlatformWindowsDefault"][1]["comment"] = "// call in main loop. will call RenderWindow/SwapBuffers platform functions for each secondary viewport which doesn't have the ImGuiViewportFlags_Minimized flag set. May be reimplemented by user for custom rendering needs."
...
defs["igSameLine"][1]["comment"] = "// call between widgets or groups to layout them horizontally. X position given in window coordinates."
...
defs["igSaveIniSettingsToDisk"][1]["comment"] = "// this is automatically called (if io.IniFilename is not empty) a few seconds after any modification that should be reflected in the .ini file (and also by DestroyContext)."
...
defs["igSelectable"][1]["comment"] = "// \"bool selected\" carry the selection state (read-only). Selectable() is clicked is returns true so you can modify your selection state. size.x==0.0: use remaining width, size.x>0.0: specify width. size.y==0.0: use label height, size.y>0.0: specify height"
...
defs["igSeparator"][1]["comment"] = "// separator, generally horizontal. inside a menu bar or in horizontal layout mode, this becomes a vertical separator."
...
defs["igSeparatorText"][1]["comment"] = "// currently: formatted text with an horizontal line"
...
defs["igSetColumnOffset"][1]["comment"] = "// set position of column line (in pixels, from the left side of the contents region). pass -1 to use current column"
...
defs["igSetColumnWidth"][1]["comment"] = "// set column width (in pixels). pass -1 to use current column"
...
defs["igSetCursorPos"][1]["comment"] = "// [window-local] \""
...
defs["igSetCursorPosX"][1]["comment"] = "// [window-local] \""
...
defs["igSetCursorPosY"][1]["comment"] = "// [window-local] \""
...
defs["igSetCursorScreenPos"][1]["comment"] = "// cursor position in absolute coordinates"
...
defs["igSetDragDropPayload"][1]["comment"] = "// type is a user defined string of maximum 32 characters. Strings starting with '_' are reserved for dear imgui internal types. Data is copied and held by imgui. Return true when payload has been accepted."
...
defs["igSetItemDefaultFocus"][1]["comment"] = "// make last item the default focused item of a window."
...
defs["igSetItemTooltip"][1]["comment"] = "// set a text-only tooltip if preceeding item was hovered. override any previous call to SetTooltip()."
...
defs["igSetMouseCursor"][1]["comment"] = "// set desired mouse cursor shape"
...
defs["igSetNextFrameWantCaptureKeyboard"][1]["comment"] = "// Override io.WantCaptureKeyboard flag next frame (said flag is left for your application to handle, typically when true it instructs your app to ignore inputs). e.g. force capture keyboard when your widget is being hovered. This is equivalent to setting \"io.WantCaptureKeyboard = want_capture_keyboard\"; after the next NewFrame() call."
...
defs["igSetNextFrameWantCaptureMouse"][1]["comment"] = "// Override io.WantCaptureMouse flag next frame (said flag is left for your application to handle, typical when true it instucts your app to ignore inputs). This is equivalent to setting \"io.WantCaptureMouse = want_capture_mouse;\" after the next NewFrame() call."
...
defs["igSetNextItemAllowOverlap"][1]["comment"] = "// allow next item to be overlapped by a subsequent item. Useful with invisible buttons, selectable, treenode covering an area where subsequent items may need to be added. Note that both Selectable() and TreeNode() have dedicated flags doing this."
...
defs["igSetNextItemOpen"][1]["comment"] = "// set next TreeNode/CollapsingHeader open state."
...
defs["igSetNextItemWidth"][1]["comment"] = "// set width of the _next_ common large \"item+label\" widget. >0.0f: width in pixels, <0.0f align xx pixels to the right of window (so -FLT_MIN always align width to the right side)"
...
defs["igSetNextWindowBgAlpha"][1]["comment"] = "// set next window background color alpha. helper to easily override the Alpha component of ImGuiCol_WindowBg/ChildBg/PopupBg. you may also use ImGuiWindowFlags_NoBackground."
...
defs["igSetNextWindowClass"][1]["comment"] = "// set next window class (control docking compatibility + provide hints to platform backend via custom viewport flags and platform parent/child relationship)"
...
defs["igSetNextWindowCollapsed"][1]["comment"] = "// set next window collapsed state. call before Begin()"
...
defs["igSetNextWindowContentSize"][1]["comment"] = "// set next window content size (~ scrollable client area, which enforce the range of scrollbars). Not including window decorations (title bar, menu bar, etc.) nor WindowPadding. set an axis to 0.0f to leave it automatic. call before Begin()"
...
defs["igSetNextWindowDockID"][1]["comment"] = "// set next window dock id"
...
defs["igSetNextWindowFocus"][1]["comment"] = "// set next window to be focused / top-most. call before Begin()"
...
defs["igSetNextWindowPos"][1]["comment"] = "// set next window position. call before Begin(). use pivot=(0.5f,0.5f) to center on given point, etc."
...
defs["igSetNextWindowScroll"][1]["comment"] = "// set next window scrolling value (use < 0.0f to not affect a given axis)."
...
defs["igSetNextWindowSize"][1]["comment"] = "// set next window size. set axis to 0.0f to force an auto-fit on this axis. call before Begin()"
...
defs["igSetNextWindowSizeConstraints"][1]["comment"] = "// set next window size limits. use 0.0f or FLT_MAX if you don't want limits. Use -1 for both min and max of same axis to preserve current size (which itself is a constraint). Use callback to apply non-trivial programmatic constraints."
...
defs["igSetNextWindowViewport"][1]["comment"] = "// set next window viewport"
...
defs["igSetScrollFromPosX"][1]["comment"] = "// adjust scrolling amount to make given position visible. Generally GetCursorStartPos() + offset to compute a valid position."
...
defs["igSetScrollHereX"][1]["comment"] = "// adjust scrolling amount to make current cursor position visible. center_x_ratio=0.0: left, 0.5: center, 1.0: right. When using to make a \"default/current item\" visible, consider using SetItemDefaultFocus() instead."
...
defs["igSetScrollHereY"][1]["comment"] = "// adjust scrolling amount to make current cursor position visible. center_y_ratio=0.0: top, 0.5: center, 1.0: bottom. When using to make a \"default/current item\" visible, consider using SetItemDefaultFocus() instead."
...
defs["igSetScrollX"][1]["comment"] = "// set scrolling amount [0 .. GetScrollMaxX()]"
...
defs["igSetScrollY"][1]["comment"] = "// set scrolling amount [0 .. GetScrollMaxY()]"
...
defs["igSetStateStorage"][1]["comment"] = "// replace current window storage with our own (if you want to manipulate it yourself, typically clear subsection of it)"
...
defs["igSetTooltip"][1]["comment"] = "// set a text-only tooltip. Often used after a ImGui::IsItemHovered() check. Override any previous call to SetTooltip()."
...
defs["igSetWindowCollapsed"][1]["comment"] = "// (not recommended) set current window collapsed state. prefer using SetNextWindowCollapsed()."
...
defs["igSetWindowCollapsed"][2]["comment"] = "// set named window collapsed state"
...
defs["igSetWindowFocus"][1]["comment"] = "// (not recommended) set current window to be focused / top-most. prefer using SetNextWindowFocus()."
...
defs["igSetWindowFocus"][2]["comment"] = "// set named window to be focused / top-most. use NULL to remove focus."
...
defs["igSetWindowFontScale"][1]["comment"] = "// [OBSOLETE] set font scale. Adjust IO.FontGlobalScale if you want to scale all windows. This is an old API! For correct scaling, prefer to reload font + rebuild ImFontAtlas + call style.ScaleAllSizes()."
...
defs["igSetWindowPos"][1]["comment"] = "// (not recommended) set current window position - call within Begin()/End(). prefer using SetNextWindowPos(), as this may incur tearing and side-effects."
...
defs["igSetWindowPos"][2]["comment"] = "// set named window position."
...
defs["igSetWindowSize"][1]["comment"] = "// (not recommended) set current window size - call within Begin()/End(). set to ImVec2(0, 0) to force an auto-fit. prefer using SetNextWindowSize(), as this may incur tearing and minor side-effects."
...
defs["igSetWindowSize"][2]["comment"] = "// set named window size. set axis to 0.0f to force an auto-fit on this axis."
...
defs["igShowAboutWindow"][1]["comment"] = "// create About window. display Dear ImGui version, credits and build/system information."
...
defs["igShowDebugLogWindow"][1]["comment"] = "// create Debug Log window. display a simplified log of important dear imgui events."
...
defs["igShowDemoWindow"][1]["comment"] = "// create Demo window. demonstrate most ImGui features. call this to learn about the library! try to make it always available in your application!"
...
defs["igShowFontSelector"][1]["comment"] = "// add font selector block (not a window), essentially a combo listing the loaded fonts."
...
defs["igShowIDStackToolWindow"][1]["comment"] = "// create Stack Tool window. hover items with mouse to query information about the source of their unique ID."
...
defs["igShowMetricsWindow"][1]["comment"] = "// create Metrics/Debugger window. display Dear ImGui internals: windows, draw commands, various internal state, etc."
...
defs["igShowStyleEditor"][1]["comment"] = "// add style editor block (not a window). you can pass in a reference ImGuiStyle structure to compare to, revert to and save to (else it uses the default style)"
...
defs["igShowStyleSelector"][1]["comment"] = "// add style selector block (not a window), essentially a combo listing the default styles."
...
defs["igShowUserGuide"][1]["comment"] = "// add basic help/info block (not a window): how to manipulate ImGui as an end-user (mouse/keyboard controls)."
...
defs["igSliderFloat"][1]["comment"] = "// adjust format to decorate the value with a prefix or a suffix for in-slider labels or unit display."
...
defs["igSmallButton"][1]["comment"] = "// button with (FramePadding.y == 0) to easily embed within text"
...
defs["igSpacing"][1]["comment"] = "// add vertical spacing."
...
defs["igStyleColorsClassic"][1]["comment"] = "// classic imgui style"
...
defs["igStyleColorsDark"][1]["comment"] = "// new, recommended style (default)"
...
defs["igTabItemButton"][1]["comment"] = "// create a Tab behaving like a button. return true when clicked. cannot be selected in the tab bar."
...
defs["igTableAngledHeadersRow"][1]["comment"] = "// submit a row with angled headers for every column with the ImGuiTableColumnFlags_AngledHeader flag. MUST BE FIRST ROW."
...
defs["igTableGetColumnCount"][1]["comment"] = "// return number of columns (value passed to BeginTable)"
...
defs["igTableGetColumnFlags"][1]["comment"] = "// return column flags so you can query their Enabled/Visible/Sorted/Hovered status flags. Pass -1 to use current column."
...
defs["igTableGetColumnIndex"][1]["comment"] = "// return current column index."
...
defs["igTableGetColumnName"][1]["comment"] = "// return \"\" if column didn't have a name declared by TableSetupColumn(). Pass -1 to use current column."
...
defs["igTableGetRowIndex"][1]["comment"] = "// return current row index."
...
defs["igTableGetSortSpecs"][1]["comment"] = "// get latest sort specs for the table (NULL if not sorting).  Lifetime: don't hold on this pointer over multiple frames or past any subsequent call to BeginTable()."
...
defs["igTableHeader"][1]["comment"] = "// submit one header cell manually (rarely used)"
...
defs["igTableHeadersRow"][1]["comment"] = "// submit a row with headers cells based on data provided to TableSetupColumn() + submit context menu"
...
defs["igTableNextColumn"][1]["comment"] = "// append into the next column (or first column of next row if currently in last column). Return true when column is visible."
...
defs["igTableNextRow"][1]["comment"] = "// append into the first cell of a new row."
...
defs["igTableSetBgColor"][1]["comment"] = "// change the color of a cell, row, or column. See ImGuiTableBgTarget_ flags for details."
...
defs["igTableSetColumnEnabled"][1]["comment"] = "// change user accessible enabled/disabled state of a column. Set to false to hide the column. User can use the context menu to change this themselves (right-click in headers, or right-click in columns body with ImGuiTableFlags_ContextMenuInBody)"
...
defs["igTableSetColumnIndex"][1]["comment"] = "// append into the specified column. Return true when column is visible."
...
defs["igTableSetupScrollFreeze"][1]["comment"] = "// lock columns/rows so they stay visible when scrolled."
...
defs["igText"][1]["comment"] = "// formatted text"
...
defs["igTextColored"][1]["comment"] = "// shortcut for PushStyleColor(ImGuiCol_Text, col); Text(fmt, ...); PopStyleColor();"
...
defs["igTextDisabled"][1]["comment"] = "// shortcut for PushStyleColor(ImGuiCol_Text, style.Colors[ImGuiCol_TextDisabled]); Text(fmt, ...); PopStyleColor();"
...
defs["igTextUnformatted"][1]["comment"] = "// raw text without formatting. Roughly equivalent to Text(\"%s\", text) but: A) doesn't require null terminated string if 'text_end' is specified, B) it's faster, no memory copy is done, no buffer size limits, recommended for long chunks of text."
...
defs["igTextWrapped"][1]["comment"] = "// shortcut for PushTextWrapPos(0.0f); Text(fmt, ...); PopTextWrapPos();. Note that this won't work on an auto-resizing window if there's no other widgets to extend the window width, yoy may need to set a size using SetNextWindowSize()."
...
defs["igTreeNode"][2]["comment"] = "// helper variation to easily decorelate the id from the displayed string. Read the FAQ about why and how to use ID. to align arbitrary text at the same level as a TreeNode() you can use Bullet()."
...
defs["igTreePop"][1]["comment"] = "// ~ Unindent()+PopID()"
...
defs["igTreePush"][1]["comment"] = "// ~ Indent()+PushID(). Already called by TreeNode() when returning true, but you can call TreePush/TreePop yourself if desired."
...
defs["igUnindent"][1]["comment"] = "// move content position back to the left, by indent_w, or style.IndentSpacing if indent_w <= 0"
...
defs["igUpdatePlatformWindows"][1]["comment"] = "// call in main loop. will call CreateWindow/ResizeWindow/etc. platform functions for each secondary viewport, and DestroyWindow for each inactive viewport."
